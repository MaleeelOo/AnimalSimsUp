...
namespace animalsimsup
{
    ...
    class Katze : Animal
    {
        ...
        public override void timer()
        {
            ...
            MainWindow.mainwindow.Katze_Liebe.Value = liebe;
            MainWindow.mainwindow.Katze_Essen.Value = essen;
            MainWindow.mainwindow.Katze_Schlaf.Value = schlaf;
            MainWindow.mainwindow.Katze_Sauberkeit.Value = sauberkeit;
        }
    }
    ...
    class Fisch : Animal
    {
        ...
        public override void timer()
        {
            ...
            MainWindow.mainwindow.Fisch_Liebe.Value = liebe;
            MainWindow.mainwindow.Fisch_Essen.Value = essen;
            MainWindow.mainwindow.Fisch_Schlaf.Value = schlaf;
            MainWindow.mainwindow.Fisch_Sauberkeit.Value = sauberkeit;
        }
    }
}
